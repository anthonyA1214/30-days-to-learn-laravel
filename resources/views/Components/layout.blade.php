...
<body class="h-full">
    <div class="min-h-full">
                        ...
                        <div class="ml-4 flex items-center md:ml-6 space-x-4">
                            ...
                            @auth             
                                <form method="POST" action="/logout">
                                    ...
                                    <button type="submit" class="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 cursor-pointer">Log Out</button>
                                </form>
                            @endauth
                        </div>
                    </div>
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm font-medium text-gray-400">larry@laracasts.com</div>
                        </div>
        ...
        <header class="relative bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-between content-center">
